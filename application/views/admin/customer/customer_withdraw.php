            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Customer Withdraw</strong>
                    </div>
                    <div class="card-body">
	...
	<div>
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<div id="pay-invoice">
					<div class="card-body">
						<form id="#withdraw_aprv_form" method="post" accept-charset="utf-8" action="<?php echo base_url('approve_withdraw'); ?>">
							...
							<div id="refund-coin" class="form-group">
								<label for="refund_coin" class="control-label mb-1">Refund Coin</label>
								<input id="refund_coin" type="text" name="refund_coin" class="form-control" value="0">
							</div>
							<div>
...
// 		$.ajax({
// 			type: 'POST',
// 			url: "<?php //echo base_url('approve_withdraw'); ?>",
// 			data: $(this).serialize(),
// 			dataType: 'json',
// 		}).done(function (data) {
// 			if (data.st == 200) {
		...
		swal(
			{
				...
				if (isConfirm) {
					$.ajax({
						type: 'POST',
						url: "<?php echo base_url('admin/remove_withdraw'); ?>",
						data: {id:id},
...
<script>
	...
	function fetch_data(status)
	{
		...
		dataTable = $('#data-table').DataTable({
			...
			"ajax": {
				url: base_url+"admin/customer_withdraw_dt",
				type: "POST",
				data: {
					status: status
				}
